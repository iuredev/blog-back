...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Site-wide settings and profile data';
    displayName: 'Global';
    pluralName: 'globals';
    singularName: 'global';
  };
...
export interface ApiManualManual extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::manual.manual'>;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiReadingReading extends Struct.SingleTypeSchema {
